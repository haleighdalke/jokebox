...
# ----Ratings-----
rating1 = Rating.create(score: 2, joke: joke4, rated_by_user_id: user1)
rating2 = Rating.create(score: 5, joke: joke2, rated_by_user_id: user2)
rating3 = Rating.create(score: 5, joke: joke1, rated_by_user_id: user1)